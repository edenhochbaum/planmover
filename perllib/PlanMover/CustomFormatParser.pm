package PlanMover::CustomFormatParser;

use strict;
use warnings;

# This module defines the logic engaged by the SQL::Translator framework to parse
# custom rds schema definitions.
#
# See:
# 	planmover/schema/rds_schema_schema.json
# 	planmover/schema/rds_schema.json
